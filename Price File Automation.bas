Sub Price_File_Automation_PrePP()
    ...
    If LastRowMaster > 11 Then
        ...
        If StrFileExists = "" Then
            ...
            ActiveWorkbook.Sheets(1).Range("G1").Value = "Selling Price £"
            ...
            ActiveWorkbook.Sheets(1).Range("N1").Value = "Agreed Contract Support £"
            ActiveWorkbook.Sheets(1).Range("O1").Value = "Agreed Net Price £"
